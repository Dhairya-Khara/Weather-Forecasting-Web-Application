            ...
            return (
                <div>
                    <div className='future_card_desktop'>
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day2Icon + "@2x.png"}></img>
                    ...
                    <div className='future_card_mobile'>
                        ...
                        <p>{Math.round(parseFloat(this.props.day2Max))}°/{Math.round(parseFloat(this.props.day2Min))}°</p>
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day2Icon + ".png"}></img>
                        <p>{this.props.day2Description}</p>
                    </div>
                </div>
            )
            ...
            return (
                <div>
                    <div className='future_card_desktop'>
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day3Icon + "@2x.png"}></img>
                    ...
                    <div className='future_card_mobile'>
                        ...
                        <p>{Math.round(parseFloat(this.props.day3Max))}°/{Math.round(parseFloat(this.props.day3Min))}°</p>
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day3Icon + ".png"}></img>
                        <p>{this.props.day3Description}</p>
                    </div>
                </div>
            )
            ...
            return (
                <div>
                    <div className='future_card_desktop'>
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day4Icon + "@2x.png"}></img>
                    ...
                    <div className='future_card_mobile'>
                        ...
                        <p>{Math.round(parseFloat(this.props.day4Max))}°/{Math.round(parseFloat(this.props.day4Min))}°</p>
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day4Icon + ".png"}></img>
                        <p>{this.props.day4Description}</p>
                    </div>
                </div>
            )
            ...
            return (
                <div>
                    <div className='future_card_desktop'>
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day5Icon + "@2x.png"}></img>
                    ...
                    <div className='future_card_mobile'>
                        ...
                        <p>{Math.round(parseFloat(this.props.day5Max))}°/{Math.round(parseFloat(this.props.day5Min))}°</p>
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day5Icon + ".png"}></img>
                        <p>{this.props.day5Description}</p>
                    </div>
                </div>
            )
            ...
            return (
                <div>
                    <div className='future_card_desktop'>
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day6Icon + "@2x.png"}></img>
                    ...
                    <div className='future_card_mobile'>
                        ...
                        <p>{Math.round(parseFloat(this.props.day6Max))}°/{Math.round(parseFloat(this.props.day6Min))}°</p>
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day6Icon + ".png"}></img>
                        <p>{this.props.day6Description}</p>
                    </div>
                </div>
            )
            ...
            return (
                <div>
                    <div className='future_card_desktop'>
                        ...
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day7Icon + "@2x.png"}></img>
                    ...
                    <div className='future_card_mobile'>
                        ...
                        <p>{Math.round(parseFloat(this.props.day7Max))}°/{Math.round(parseFloat(this.props.day7Min))}°</p>
                        <img src={"http://openweathermap.org/img/wn/" + this.props.day7Icon + ".png"}></img>
                        <p>{this.props.day7Description}</p>
                    </div>
                </div>
            )
